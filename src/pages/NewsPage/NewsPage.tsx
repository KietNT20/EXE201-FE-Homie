  ...
  const NewsPage = () => {
    const newsItems = [
      ...
      },
      {
        ...
        link: '#',
        content: 'Chương trình khuyến mãi lớn nhất trong năm với nhiều ưu đãi hấp dẫn. Đừng bỏ lỡ cơ hội sở hữu những sản phẩm chất lượng với giá cực kỳ ưu đãi. Hãy nhanh tay đặt hàng để nhận ngay những ưu đãi đặc biệt từ chúng tôi.'
      },
      {
        id: 3,
        ...
        link: '#',
        content: 'Hợp tác đặc biệt giữa MoMo và Homie mang đến cho bạn những ưu đãi không thể bỏ qua. Thanh toán qua MoMo để nhận ngay những phần quà hấp dẫn và giảm giá đặc biệt. Hãy trải nghiệm ngay dịch vụ của chúng tôi với những ưu đãi tuyệt vời này.'
      },
      {
        id: 4,
        ...
        link: '#',
        content: 'VNPay và Homie cùng nhau mang đến cho bạn những ưu đãi đặc biệt trong tháng 6. Thanh toán qua VNPay để nhận ngay những phần quà hấp dẫn và giảm giá đặc biệt. Đừng bỏ lỡ cơ hội này để trải nghiệm dịch vụ của chúng tôi với giá ưu đãi.'
      },
      {
        id: 5,
